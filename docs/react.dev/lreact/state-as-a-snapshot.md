...
3. React then updates the screen to match the snapshot your function returned.
    ...
    < caption="React executing the function" src="/images/docs/s/i_render1.png" />
    < caption="Calculating the snapshot" src="/images/docs/s/i_render2.png" />
    < caption="Updating the DOM tree" src="/images/docs/s/i_render3.png" />


As a component's memory, state is not like a regular variable that disappears after your function returns. State actually "lives" in React itself--as if on a shelf!--outside of your function. When React calls your component, it gives you a snapshot of the state for that particular render. Your component returns a snapshot of the UI with a fresh set of props and event handlers in its JSX, all calculated **using the state values from that render!**


  < caption="You tell React to update the state" src="/images/docs/s/i_state-snapshot1.png" />
  < caption="React updates the state value" src="/images/docs/s/i_state-snapshot2.png" />
  < caption="React passes a snapshot of the state value into the component" src="/images/docs/s/i_state-snapshot3.png" />
