...
To create a portal, render the result of `createPortal` with some JSX and the {2}>DOM node where it should go:
...
React will put the DOM nodes for the JSX you passed inside of the {2}>DOM node you provided.
