...
2. The {2}>`set` function that lets you change it to any other value in response to interaction.
...
Here, `a => a + 1` is your updater function. It takes the pending state and calculates the {2}>next state from it.
