...
To create an element without JSX, call `createElement` with some type, {2}>props, and {3}>children:
...
The {3}>children are optional, and you can pass as many as you need (the example above has three children). This code will display a `<h1>` header with a greeting. For comparison, here is the same example rewritten with JSX:
